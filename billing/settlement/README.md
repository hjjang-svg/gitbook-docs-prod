...
### 정산서 조회 <a href="#settlement-statement" id="settlement-statement"></a>

* 매월 1일 부터 말일까지 실제 집행된 광고에 대해 **유상 비즈머니** 소진 금액을 기준으로 **익월 1일**에 정산서가 생성돼요.
  * 비즈니스 그룹의 \[그룹 관리] → \[정산] 버튼을 눌러 각 광고계정의 정산 내역을 확인할 수 있어요.
...
### 세금계산서 발행 <a href="#tax-invoice" id="tax-invoice"></a>

* 광고계정 생성 시 등록한 **사업자 등록번호**로 매월 1일 \~ 말일에 실제 집행된 광고에 대해, 유상 머니 소진금을 기준으로 **월 1회** 세금계산서가 발행돼요.
...
- 발행 대상 : 해당 월에 유상 광고머니를 이용해 광고를 집행한 이력이 있는 광고계정
- 작성 일자 : 해당 월의 말일
- 수신 이메일주소 : 광고계정의 **대표 이메일** 주소
{% endhint %}

※ 일부 에이전시 계정의 경우 **사전 협의**를 통해 사업자 등록번호 단위로 1장 발행 가능해요.

※ 세금계산서 수정 발행이 필요한 경우, [bo.team@toss.im](mailto:bo.team@toss.im) 메일로 문의 주시면 확인 후 순차적으로 도움 드리고 있어요.

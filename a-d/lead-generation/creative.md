...
* **공개 제목 (고객에게 보여줄 이름)**
  ...
  * 광고 효율을 위해 브랜드명을 포함하여 입력하는 것을 권장해요.
    * 유저가 설문 완료된 것으로 오인할 수 있는 문장으로 구성하는 경우 정보 수집이 원활하지 않을 수 있으니 유의해 주세요.
...
* **참고 URL (필수)**
  * 소재 심사에 활용될 이벤트 페이지 랜딩 URL을 입력해 주세요.
...
* [**URL 주소는 반드시 영문으로 제출해주셔야 해요**](../../review/creativeguide.md#landing-and-deeplink)**.**
  ...
  * 링크 내에 { } ^ # 문구가 있으면 반려될 수 있어요.
    * ^ 대신 \_(언더바)를 사용해 주세요.
  * http:// 는 사용이 불가하여 https:// 를 사용해 주세요.
...
* 그 외 공통으로 적용되는 규정은 [소재 심사 규정](../../review/creativeguide.md#landing-and-deeplink) 을 참고해 주세요.
{% endtab %}
{% endtabs %}

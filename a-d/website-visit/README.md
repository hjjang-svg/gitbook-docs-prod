...
![](https://static.toss.im/illusts-common/ad_mo_visit.png)

방문 유도하기는 광고를 클릭한 사용자를 광고주가 정한 랜딩 페이지로 보내 방문을 늘리는 퍼포먼스 광고예요. 이 문서를 따라 하면 방문 유도하기 캠페인과 광고 세트를 설정하고, 소재를 등록할 준비를 마칠 수 있어요.
...
| 단계        | 설정하는 것                                       |
| --------- | -------------------------------------------- |
| **캠페인**   | 광고 목표, 집행 기간, 총 예산을 설정하고 하위 광고 세트와 소재를 관리해요. |
| **광고 세트** | 일 예산, 입찰 방식, 타겟, 노출 일정을 설정해요.                |
| **소재**    | 사용자에게 실제로 보이는 문구·이미지·비디오를 설정해요.              |

{% hint style="info" %}
소재 규격과 제작 기준은 [배너 소재 가이드](../creative-guidelines/)에서 확인할 수 있어요. 이 문서에서는 캠페인과 광고 세트까지 다뤄요.
{% endhint %}
...
* **전환 및 추적 연동(선택)**
  * 광고 클릭 이후의 행동까지 측정하고 싶다면 [전환 추적 코드를 생성](../../tracking/tag/code_generation.md)해 주세요.
...
캠페인 하위에 광고 세트를 만들어 일 예산, 입찰 방식, 타겟, 노출 일정을 설정해요.
...
* 주류·담배·전자담배·데이팅·게임(성인 등급) 등 미성년자 보호 정책에 해당하는 업종·소재는 성인 타겟팅을 반드시 사용해야 해요. 자세한 대상은 [성인 타겟팅 필수 업종·소재](../../review/basicguide.md#minor-protection) 가이드에서 확인할 수 있어요.
...
광고 세트까지 설정했다면, [배너 소재 가이드](../creative-guidelines/)에서 소재를 등록하고 심사를 신청해주세요.

광고 세트까지 설정했다면 [배너 소재 가이드](../creative-guidelines/)를 참고해 문구·이미지·비디오 소재를 등록해 주세요.

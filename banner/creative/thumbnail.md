...
* [보드 부분 이미지](thumbnail.md#image-setup-guide)
* [보드 전체 이미지](thumbnail.md#image-setup-guide)
* [보드 비디오](thumbnail.md#video-setup-guide)
...
## 이미지 유형 설정 가이드 <a href="#image-setup-guide" id="image-setup-guide"></a>

* [업종 별 심사 가이드](../../review/industryguide.md#industry-overview)에 따라 심의필 제출이 필수 업종인 경우, 카테고리를 선택하고 안내 문구 기재란에 작성해주시면 이미지 상단 영역에 자동으로 반영돼요.

{% tabs %}
{% tab title="부분 이미지 유형" %}
<figure><img src="../../.gitbook/assets/부분 이미지_영역 안내 (2).png" alt=""><figcaption></figcaption></figure>

### 부분 이미지 타입 <a href="#board-partial-image" id="board-partial-image"></a>
...
### 전체 이미지 타입 <a href="#board-full-image" id="board-full-image"></a>
...
## 영상 유형 설정 가이드 <a href="#video-setup-guide" id="video-setup-guide"></a>
...
{% tabs %}
{% tab title="광고 영상 " %}
<figure><img src="../../.gitbook/assets/영상 유형_영역 안내.png" alt=""><figcaption></figcaption></figure>

### 영상 리소스 <a href="#board-video" id="board-video"></a>

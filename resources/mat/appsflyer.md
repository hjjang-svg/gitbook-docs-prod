...
* AppsFlyer 이벤트 라벨은 AppsFlyer에서 사용 중인 기본 명칭으로 기재되었어요. 자사 서비스에서 발생하는 이벤트를 기준으로 [토스애즈의 표준이벤트](https://toss-ads.gitbook.io/guide/resources/tag/tracked-events)와 가장 적절한 이벤트에 매핑해 주세요.
{% endhint %}

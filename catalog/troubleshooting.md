...
1. 자동 등록이라면 상품 목록 URL이 `https://`로 시작하고 누구나 접근할 수 있는지 확인해 주세요.
...
| 이미지 해상도 미달    | 이미지의 가로나 세로가 500px보다 작아요                                    | 가로와 세로가 모두 500px 이상인 이미지로 교체해 주세요                                                   | `image_url`                                                 |
...
| 이미지 비율 권장 미충족  | 이미지 비율이 허용 범위 안이지만 1:1이 아니에요                                       | 1:1 비율의 이미지로 교체하는 것을 권장해요. 광고 성과에 영향을 줄 수 있어요                                                                         | `image_url`                                                                |
| 할인 기간 형식 오류    | 할인 기간 형식이 맞지 않아요                                                   | ISO 8601 형식으로 시작일과 종료일을 모두 입력해 주세요                                                                                    | `sale_price_effective_date`                                                |
| 할인 기간 범위 오류    | 할인 기간 시작일이 종료일보다 늦어요                                               | 시작일을 종료일보다 이른 날짜로 바꿔 주세요                                                                                              | `sale_price_effective_date`                                                |

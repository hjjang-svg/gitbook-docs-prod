...
* 소재를 따로 만들지 않아도 등록한 상품이 카드형 광고로 자동 노출돼요.
...
* 주기는 매일/매주/12시간/4시간 중에 선택하고, 시각을 지정할 수 있어요. 12시간/4시간처럼 하루에 여러 번 반복되는 주기는 지정한 시각을 시작점으로 삼아요.
* 기본값은 매일 오전 9시예요.
...
{% hint style="warning" %}
**2026. 9. 15**부터 모든 상품에 AI 상품명 최적화가 적용돼요. 이전에 등록한 상품도 포함돼요.
{% endhint %}

**AI 상품명 최적화**는 원본 상품명을 최대한 유지하면서 광고에 노출할 상품명을 정규화하는 기능이에요. 브랜드명을 중복 없이 상품명 맨 앞에 배치하고 쉼표 같은 표기 방식을 통일해, 이용자가 여러 상품의 핵심 정보를 쉽게 비교할 수 있어요.
...
## 카탈로그 준비 완료 확인하기 <a href="#undefined-13" id="undefined-13"></a>
...
## 다음 단계 <a href="#undefined-14" id="undefined-14"></a>
